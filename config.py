...
API_ID = int(getenv("27000997"))
API_HASH = getenv("022a64d35926dfb807925d7c6eda416a")
...
LOG_CHANNEL = int(os.environ.get("@ram_rajya_01")) # make a private channel and get the channel id
